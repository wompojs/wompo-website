import{Fragment as n,jsx as e,jsxs as o}from"wompo/jsx-runtime";import{defineWompo as s}from"wompo";import a from"../../utils/getPageLayout.js";import t from"../../components/Code.js";import i from"../../components/Note.js";const c={title:"How to use JSX",description:"Use JSX to make the editor help you while building your components.",sections:[{title:"What is JSX",id:"what-is-jsx",content:o(n,{children:[o("p",{children:[e("b",{children:"JSX"})," is an extension of JavaScript that allows to write Markup code into your JS files. This makes creating your layouts easier, because the editor can help you by suggesting code and reporting errors in the markup. It will also check your component's props to find mistakes and type incompatibilites if you also use Typescript. An example of a JSX component is the following:"]}),e(t,{code:`
              ...
              defineWompo(Section);
            `,language:"js"}),o("p",{children:["As you can see, the ",e("code",{children:"html"})," function is not used to build the layout. Instead, you directly write your HTML into your component."]}),o(i,{severity:"warning",children:[e("b",{children:"Note:"})," JSX files need a compiler. JSX is not natively supported by browsers."]}),e("p",{children:"The code in the example will be transformed by the compiler into the following:"}),e(t,{code:`
