			...
			content: e(n, {
				children: o('p', {
					children: [
						...
						o('ol', {
							children: [
								e('li', { children: 'Classic CSS file' }),
								e('li', { children: "Through the Component's css poperty (for shadow elements)" }),
								e('li', { children: 'Built-in CSS "modules"' }),
							],
						}),
					],
				}),
