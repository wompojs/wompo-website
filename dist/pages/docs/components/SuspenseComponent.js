							...
							children: [
								o('li', {
									children: [
										...
										e(t, { to: '/docs/hooks/useAsync', children: 'useAsync' }),
										' hook',
									],
								}),
								o('li', {
									children: [
										...
										e(t, { to: '/docs/apis/lazy', children: 'lazy' }),
										' ',
										'function',
									],
								}),
				...
				children: [
					...
					o('p', {
						children: [
							...
							e(t, { to: '/docs/apis/html', children: 'html' }),
							' template function. This prop is ',
							e('b', { children: 'required' }),
							'.',
						],
					}),
				],
...
p(i, { name: 'suspense-component-page' });
