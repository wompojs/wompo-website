...
import c from '../../components/Note.js';
const u = {
	title: 'Quick Start',
	...
	sections: [
            ...
            `,
					...
					t('p', {
						children: [
							...
							' ',
							e(a, { to: '/docs/apis/defineWompo', children: 'defineWompo' }),
							' for more.',
							e('br', {}),
		...
		},
		{
			...
			content: t(o, {
				children: [
					e('p', { children: 'Why did we decide to implement an automatic naming system?' }),
					t('p', {
						children: [
            ...
            `,
					...
					e('p', { children: 'Wompo will automatically convert the dynamic tag into:' }),
					e(n, {
						code: `
              function App() {
            ...
            `,
					...
					t('p', {
						children: [
							...
							e('i', { children: 'Why did we decide to implement an automatic naming?' }),
							'".',
							e('br', {}),
		...
		},
		{
				...
				children: [
					t('p', {
						children: [
							...
							' ',
							e('b', { children: e('u', { children: 'props' }) }),
            ...
            `,
					...
					e(c, {
						severity: 'info',
						children:
							'If you use a variable as an attribute value, you must not add quotes around the value: the attribute name must only be followed by an equal ("=") and the value.',
					}),
				],
			}),
		},
				...
				children: [
					t('p', {
						children: [
							...
							e('code', { children: '@click' }),
							', change will be ',
							e('code', { children: '@change' }),
							', ans so on).',
							e('br', {}),
