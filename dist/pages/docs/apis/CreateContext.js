import{Fragment as o,jsx as e,jsxs as t}from"womp/jsx-runtime";import{defineWomp as i}from"womp";import s from"../../../utils/getPageLayout.js";import n from"../../../components/Code.js";import{Link as a}from"womp-router";import r from"../../../examples/ThemeExample.js";const c={title:"createContext API",description:t(o,{children:["How to use the ",e("code",{children:"createContext"})," function to create a new Context and share some data to all its children."]}),sections:[{title:"Description",id:"description",content:e(o,{children:t("p",{children:["The ",e("code",{children:"createContext"})," function allows to create a new ",e("b",{children:"Context"}),". A context is a piece of data that is shared across all the children. This can be quite useful if:",t("ul",{children:[e("li",{children:"You want to pass a prop deeply in the component's tree"}),e("li",{children:"You want to manage a portion of the app from a centralized place"})]})]})})},{title:"Usage",id:"usage",content:t(o,{children:[e(n,{code:`
              ...
              function App(){
                ...
                \`;
						...
						`,language:"js"}),t("p",{children:["In the above example, a ",e("code",{children:"ThemeContext"})," is created and a"," ",e("code",{children:"ThemeContext.Provider"})," instance is rendered so that the current theme is shared across the whole application (assuming the ",e("code",{children:"App"})," component is your root). A custom theme state is used as a value for the provider. When the theme changes, the provider will be re-rendered, and so all the children of it that uses that context. To make a component listen to the changes of the provider, you have to use the"," ",e(a,{to:"/docs/hooks/useContext",children:"useContext"})," hook and pass as the first argument the ",e("code",{children:"ThemeContext"})," (in this case). If a component doesn't use the"," ",e("code",{children:"useContext"}),"hook, it will not be automatically re-rendered when the parent provider changes."]})]})},{title:"Example: theme",id:"theme-example",content:t(o,{children:[e("p",{children:"We can go further with the theme example and actually implement a small app:"}),e(n,{code:`
