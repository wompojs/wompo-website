import { Fragment as t, jsx as o, jsxs as e } from 'wompo/jsx-runtime';
import { defineWompo as p } from 'wompo';
import s from '../../../utils/getPageLayout.js';
import a from '../../../components/Code.js';
	...
	sections: [
		{
			...
			content: o(t, {
				children: e('p', {
					children: [
						'Wompo exposes a ',
						o('code', { children: 'wompDefaultOptions' }),
						' object that is used to get the default values to use as the second parameter of the',
						' ',
						o(i, { to: '/docs/apis/defineWompo', children: 'defineWompo' }),
						' function.',
						o('br', {}),
						...
						e('ul', {
							children: [
								e('li', {
									children: [
										o('b', { children: o('code', { children: 'shadow' }) }),
										' ',
										'- Default "false".',
									],
								}),
								e('li', {
									children: [
										o('b', { children: o('code', { children: 'cssModule' }) }),
										' ',
										'- Default "true".',
									],
								}),
						...
						' ',
						o(i, { to: '/docs/apis/defineWompo#usage', children: 'defineWompo' }),
						' function.',
					],
				}),
			}),
				...
				children: [
					e('p', {
						children: [
							...
							' ',
							o('b', { children: 'before you define any other component' }),
							'. Components rendered ',
							o('i', { children: 'before' }),
...
p(n, { name: 'wompo-default-options-apis-page' });
