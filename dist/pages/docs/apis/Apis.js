import { Fragment as s, jsx as e, jsxs as t } from 'wompo/jsx-runtime';
import { defineWompo as l } from 'wompo';
import a from '../../../utils/getPageLayout.js';
import { Link as o } from 'wompo-router';
					...
					children: [
						...
						t('ul', {
							children: [
								...
								t('li', {
									children: [
										e(o, { to: 'registeredComponents', children: 'registeredComponents' }),
		...
		},
		{
			...
			content: e(s, {
				children: t('p', {
					children: [
						'The ',
						e(o, { to: 'element', children: 'Element API' }),
			...
			content: e(s, {
				children: t('p', {
                  ...
                  `,
								...
								t('li', {
									children: [
										e('code', { children: 'WompoComponentOptions' }),
                  ...
                  `,
								...
								t('li', {
									children: [
										e('code', {
											children: 'WompoComponent<Props extends WompoProps = WompoProps>',
										}),
										" - It's the",
										' ',
										e('b', { children: 'functional' }),
										" component's type.",
										e(n, {
											code: `
                  ...
                  `,
								...
								t('li', {
									children: [
										e('code', { children: 'LazyCallbackResult' }),
