			...
			content: e(n, {
				children: o('p', {
					children: [
						...
						e('code', { children: 'CustomElementRegistry' }),
				...
				children: [
					...
					o('p', {
						children: [
							...
							' ',
							e(i, { to: '/docs/apis/html', children: 'html' }),
							' result or ',
							e('code', { children: 'null' }),
							'. The second parameter is ',
							e('b', { children: 'optional' }),
							', but if defined it must be an object with the following optional keys:',
							o('ul', {
								children: [
									o('li', {
										children: [
											e('code', { children: 'name' }),
                  ...
                  `,
					...
					o(a, {
						...
						children: [
							...
							e('b', { children: 'options' }),
							' object by overriding the values present in the ',
							e(i, { to: '/docs/apis/wompoDefaultOptions', children: 'wompDefaultOptions' }),
							' ',
							'object.',
						],
					}),
                ...
                cssModule: false
					...
					o(a, {
						...
						children: [
							...
							e(t, { code: ':host { display: block; }', language: 'js' }),
