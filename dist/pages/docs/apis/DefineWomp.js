import{Fragment as n,jsx as e,jsxs as o}from"womp/jsx-runtime";import{defineWomp as l}from"womp";import c from"../../../utils/getPageLayout.js";import t from"../../../components/Code.js";import{Link as i}from"womp-router";import a from"../../../components/Note.js";import r from"../../../examples/IsolatedComponent.js";const p={title:"defineWomp API",description:o(n,{children:["How to use the ",e("code",{children:"defineWomp"})," function to register your custom component in your application."]}),sections:[{title:"Description",id:"description",content:e(n,{children:o("p",{children:["The ",e("code",{children:"defineWomp"})," function is the function that will register your component in the browser's ",e("code",{children:"CustomElementRegistry"}),". You always have to use this function after writing your components. If you don't see your component in the screen, don't panic: is probably because you only forgot to call this function."]})})},{title:"Usage",id:"usage",content:o(n,{children:[e(t,{code:`
							defineWomp(Component, options?);
						`,language:"js"}),o("p",{children:["The function accepts two parameters: your functional Component and the options for it. The first parameter must be a function that returns an"," ",e(i,{to:"/docs/apis/html",children:"html"})," result or ",e("code",{children:"null"}),". The second parameter is ",e("b",{children:"optional"}),", but if defined it must be an object with the following optional keys:",o("ul",{children:[o("li",{children:[e("code",{children:"name"}),` (string) - The name of the Web Component that will be registered. If not defined, the component name will be the name of the function in hyphen-case. If the component doesn't have an hyphen, a "womp" string will be placed as a suffix.`,e("br",{}),"E.g. TabPanel = tab-panel, Counter = counter-womp"]}),o("li",{children:[e("code",{children:"shadow"})," (boolean) - By default is false, but if true, the component's content will be rendered inside a Shadow Root. You want to set it to true when developing libraries and components that you want to be sure they won't affect or be affected by external CSSs or Scripts."]}),o("li",{children:[e("code",{children:"cssModule"})," (boolean) - By default is true, meaning that a CSS module logic will be applied if you write your ",e("code",{children:"component's CSS"})," inside the Component.css key. The classes that are found in there will be replaced with a more unique identifier and put in the ",e("b",{children:"styles"})," prop of the component, which will be an object having the found classes as keys and the more unique generated classes as values. This is done to avoid style collisions.",e("br",{}),"Example:",e(t,{code:`
                    ...
                    \`;
                  `,language:"js"})]})]})]}),o(a,{severity:"info",children:["You can customize the default values of the ",e("b",{children:"options"})," object by overriding the values present in the ",e(i,{to:"/docs/apis/wompDefaultOptions",children:"wompDefaultOptions"})," ","object."]})]})},{title:"Example: isoalted element",id:"isolated-element-example",content:o(n,{children:[o("p",{children:["We can use the ",e("code",{children:"defineWomp"}),' function to define a component that is "isolated" from the CSS and JS in your application.']}),e(t,{code:`
