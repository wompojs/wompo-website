...
const content = {
  ...
  description: /* @__PURE__ */ jsx(Fragment, { children: "How to get the collection of the components registered in the browser." }),
  sections: [
    {
      title: "Description",
      id: "description",
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          " constant is an object exported by the Wompo library that contains the names of the registered Web Components as keys, and their corresponding functional Component as a value (not the generated HTML class)."
        ] }),
