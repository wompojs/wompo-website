import{Fragment as n,jsx as e,jsxs as o}from"womp/jsx-runtime";import{defineWomp as a}from"womp";import s from"../../../utils/getPageLayout.js";import t from"../../../components/Code.js";import{Link as i}from"womp-router";import l from"../../../components/Note.js";import m from"../../../examples/LazyExample.js";import c from"../../../examples/LazySuspenseExample.js";const r={title:"lazy API",description:o(n,{children:["How to use the ",e("code",{children:"lazy"})," function to asynchronously load a component only when it is used."]}),sections:[{title:"Description",id:"description",content:e(n,{children:o("p",{children:["The ",e("code",{children:"lazy"})," function will dynamically import a component only if it is actually used and rendered. Using the lazy function can"," ",e("b",{children:"improve your site's performance"})," and decrease the number of network requests, other then reducing the initial payload.",e("br",{}),"You can also combine the ",e("code",{children:"lazy"})," function with the use of the"," ",e(i,{to:"/docs/components/suspense",children:"Suspense"})," component to display a rendering screen while the component is being loaded. Once the lazy component rendered for the first time, the result is cached so that multiple requests will not be performed if the lazy component is used multiple times.",e("br",{}),"The imported file ",e("b",{children:"must have a default export"}),", and it is what will be taken to know which component to render."]})})},{title:"Usage",id:"usage",content:o(n,{children:[e(t,{code:`
