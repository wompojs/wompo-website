...
import { Link as i } from 'wompo-router';
import l from '../../../components/Note.js';
import m from '../../../examples/LazyExample.js';
import c from '../../../examples/LazySuspenseExample.js';
const r = {
	title: 'lazy API',
	description: o(n, {
		children: [
			'How to use the ',
			e('code', { children: 'lazy' }),
			...
			content: e(n, {
				children: o('p', {
					children: [
						...
						' ',
						e('b', { children: "improve your site's performance" }),
						...
						' ',
						e(i, { to: '/docs/components/suspense', children: 'Suspense' }),
						...
						e('br', {}),
						'The imported file ',
						e('b', { children: 'must have a default export' }),
		...
		},
		{
			...
			content: o(n, {
				children: [
					e('p', {
						children:
							'When developing in a local environment, files are usually loaded instantly, so you cannot really test the functioning of the lazy component. But you can simulate the loading of a big file using a function that will delay the import of the component, like in the following example:',
					}),
					e(t, {
						code: `
              ...
              defineWompo(App);
					...
					e('code', { children: './custom-component.js' }),
              ...
              defineWompo(LazyComponent);
					...
					o(l, {
						...
						children: [
							...
							e('b', {
								children:
									'the children of the component will still be visible while the component is being imported',
							}),
							". That's why usually you always combine the lazy component with a ",
							e('code', { children: 'Suspense' }),
							' ',
							'component.',
						],
					}),
