    ...
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          /* @__PURE__ */ jsxs("ul", { children: [
            /* @__PURE__ */ jsxs("li", { children: [
              ...
              ` (string) - The name of the Web Component that will be registered. If not defined, the component name will be the name of the function in hyphen-case. If the component doesn't have an hyphen, a "wompo" string will be placed as a suffix.`,
              /* @__PURE__ */ jsx("br", {}),
              "E.g. TabPanel = tab-panel, Counter = counter-wompo"
            ] }),
            /* @__PURE__ */ jsxs("li", { children: [
              /* @__PURE__ */ jsx("code", { children: "shadow" }),
              " (boolean) - By default is false, but if true, the component's content will be rendered inside a Shadow Root. You want to set it to true when developing libraries and components that you want to be sure won't affect or be affected by external Styles or scripts."
            ] }),
            /* @__PURE__ */ jsxs("li", { children: [
              /* @__PURE__ */ jsx("code", { children: "cssModule" }),
              " (boolean) - By default is true, meaning that a CSS module logic will be applied if you write your component's CSS inside the",
              /* @__PURE__ */ jsx("code", { children: "Component.css" }),
              " key. The classes that are found in there will be replaced with a more unique identifier and put in the ",
            ...
            /* @__PURE__ */ jsxs("li", { children: [
              /* @__PURE__ */ jsx("code", { children: "island" }),
              " (",
              /* @__PURE__ */ jsx("code", { children: "'load' | 'idle' | 'visible'" }),
              ") - When set, every instance of this component is treated as an SSR island and hydrated on the client according to this trigger. Per call-site, you can override the default with the",
              ...
              " ",
              "attributes, or opt out with ",
              /* @__PURE__ */ jsx("code", { children: "client:none" }),
              ". See the",
              " ",
              /* @__PURE__ */ jsx(Link, { to: "/docs/ssr#islands", children: "SSR islands" }),
              " section for details."
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs(Note, { severity: "info", children: [
          ...
          " ",
          /* @__PURE__ */ jsx(Link, { to: "/docs/apis/wompoDefaultOptions", children: "wompDefaultOptions" }),
          " object."
        ] })
      ] })
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs(Note, { severity: "warning", children: [
          ...
          /* @__PURE__ */ jsx(Code, { code: `:host { display: block; }`, language: "js" }),
