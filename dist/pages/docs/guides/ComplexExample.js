  ...
  sections: [
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          '. The useRef hook allows to keep the same value of a variable during re-render, without resetting it every time. You are probably wondering why it is relevant to the current case. The answer is that the useRef hook can also be used to have a reference of a node included in your HTML structure. To do that you simply have to add the "',
