import{Fragment as n,jsx as e,jsxs as t}from"wompo/jsx-runtime";import{defineWompo as s}from"wompo";import u from"../../../utils/getPageLayout.js";import o from"../../../components/Code.js";import{Link as i}from"wompo-router";import a from"../../../components/Note.js";const l={title:"Quick Start",description:"Learn the basics of Wompo in only 5 minutes.",sections:[{title:"Creating a component",id:"creating-a-component",content:t(n,{children:[t("p",{children:[`Let's start immediately by creating your first component. All you will need to do is just create a function and "declare" the component with the helper function`," ",e("code",{children:"defineWompo"}),". This function will have to return the result of the"," ",e("code",{children:"html"})," function, which is a template function that will contain your HTML structure."]}),e(o,{code:`
            ...
            `,language:"js"}),t(a,{severity:"warning",children:[e("b",{children:"Note"}),": The last example will make the whole component dynamic. When possible, always avoid this kind of approach."]})]}),e("p",{children:t(a,{severity:"info",children:[e("b",{children:"Note"}),": If ",e("b",{children:"you know and you are sure"})," that your component will only render once, you can avoid this runaround, although it's not recommended: always use the same logic across components."]})}),e("hr",{}),t("p",{children:["The second rule you must follow is about hooks. Wompo hooks have the following rules:",t("ol",{children:[t("li",{children:["Always use them in the first lines of the component. You must think of hooks like if they were the ",e("i",{children:"import statements"})," of your file."]}),e("li",{children:"Don't use hooks conditionally, or inside loops."})]}),"If these criterias are not met, your components might not work as expected. If you want to know more about it, check the"," ",e(i,{to:"/docs/hooks/useHook#deep-dive",children:"Deep Dive into Wompo hooks"})," guide in the"," ",e("code",{children:"useHook"})," hook documentation."]})]})}]};export default function r(){return u(l)}s(r,{name:"quick-start-page"});
