    ...
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs(Note, { severity: "warning", children: [
          ...
          " Be careful if you use a minifier! The function's name will be usually replaced with a simple letter, so your component's name will not be able to be processed correctly and multiple components with the same name can be generated, leading to unexpected behaviours and bugs. In this case, you want to manually set your component's name, just to be sure they are unique."
        ] })
      ] })
    },
    {
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          /* @__PURE__ */ jsxs("ol", { children: [
            /* @__PURE__ */ jsxs("li", { children: [
              /* @__PURE__ */ jsx("b", { children: "Always use them in the first lines of the component." }),
              " You must think of hooks like if they were the ",
              /* @__PURE__ */ jsx("i", { children: "import statements" }),
              " of your file."
            ] }),
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("b", { children: "Don't use hooks conditionally, or inside loops." }) })
          ] }),
