  ...
  sections: [
    {
      ...
      content: /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("p", { children: [
        ...
        " that allows developers to satisfy those needs. You can create your own custom hooks that can then be used across all components."
      ] }) })
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          /* @__PURE__ */ jsx("b", { children: "base" }),
          ": they have the main functionalities and concepts that can be combined together to create more advanced and complex hooks. Let's see how."
        ] })
      ] })
    },
    {
