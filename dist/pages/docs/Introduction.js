      ...
      content: /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("p", { children: [
        ...
        /* @__PURE__ */ jsxs("ul", { children: [
          ...
          /* @__PURE__ */ jsxs("li", { children: [
            ...
            " - Faster than React and Preact, and only slightly slower than Lit."
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
          ...
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("b", { children: "Server-Side Rendering" }),
            " - Wompo ships a string and a streaming SSR renderer, an islands-first hydration runtime, and Server Actions. Same components, server and client."
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
    ...
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          " style. Consider the following example:"
        ] }),
        /* @__PURE__ */ jsx(
          Code,
          {
