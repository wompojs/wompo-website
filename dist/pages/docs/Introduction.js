...
import l from '../../utils/getPageLayout.js';
	...
	sections: [
		{
			...
			content: t(n, {
				children: [
					t('p', {
						children: [
							'The reason why Wompo is born is to make Web development easier: by taking advantage of native Javascript functionalities, Wompo allows you to create reusable, shareable, and fast Web-Components.',
							e('br', {}),
							...
							e('b', { children: 'Core concepts' }),
							' of React, and the ',
							e('b', { children: 'Blazing fast' }),
					...
					t('p', {
						children: [
							...
							e('b', { children: 'Stencil' }),
							', ',
							e('b', { children: 'Atomico' }),
							', and, of course ',
							e('b', { children: 'Lit' }),
							...
							e('b', { children: 'completely begginers' }),
							' ',
							'but also by ',
							e('b', { children: 'experts' }),
							'.',
						],
					}),
					t('p', {
				...
				children: [
					t('p', {
						children: [
							...
							e('i', {
								children:
									'what the hell is a Web-Component, and what is the difference between a React component and a Web-Component?',
							}),
						],
					}),
					t('p', {
						children: [
							...
							e('b', {
								children:
									'even websites that are not up-to-date with the latest technologies can easily integrate Wompo',
							}),
					...
					t('p', {
						children: [
							...
							e('i', { children: 'React components' }),
							' and ',
							e('i', { children: 'Wompo components' }),
					...
					e('p', {
						children:
							'In React this will give a different result compared to Wompo, more specifically:',
					}),
					e(o, {
						code: `
