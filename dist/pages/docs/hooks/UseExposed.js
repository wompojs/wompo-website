...
import l from '../../../examples/InteractiveExposedExample.js';
import p from '../../../components/Note.js';
const i = {
	title: 'useExposed hook',
	description: o(n, {
		children: [
			'How to use the ',
			e('code', { children: 'useExposed' }),
				...
				children: [
					o('p', {
						children: [
							...
							' ',
							e('code', { children: 'document.querySelector' }),
							' or through the',
							' ',
					...
					o('p', {
						children: [
							'Unlike ',
							e('b', { children: 'React' }),
							', Wompo components are meant to be ',
							e('u', { children: 'isolated' }),
							", meaning that their state should't dependend on props, even though it is possible. This is becasue Wompo Components are actually DOM elements, meaning that they can be accessed by other scripts and call methods or access data. This allows to ",
							e('b', { children: 'isolate' }),
							" the state and make it depend on the component itself (and that's it). A great example can be a ",
							e('b', { children: 'Modal' }),
							' ',
							'component:',
							e('br', {}),
							`In React, you would create the component and make it accept an "open" prop to handle its state. In Wompo you can also do it, but it's `,
							e('b', { children: 'not recommended' }),
							'. Instead, you want to handle the state internally by creating the ',
							e('code', { children: 'open()' }),
							' and ',
							e('code', { children: 'close()' }),
							' ',
							'methods, and call them from outside. This allows ',
							e('b', { children: 'great code reduction' }),
							" (you don't have to re-create the same logic for opening and closing the modal wherever it is used) and ",
							e('b', { children: 'isolation' }),
							'.',
						],
					}),
					o(p, {
		...
		},
		{
			...
			content: o(n, {
				children: [
					...
					e('p', {
						children:
							'The hook accepts one single parameter, which is an object representing the keys you want to expose and their corresponding values. For example:',
					}),
					e(t, {
						code: `
