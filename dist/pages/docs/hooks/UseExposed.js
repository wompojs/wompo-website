  ...
  sections: [
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          ", Wompo components state is meant to be ",
          /* @__PURE__ */ jsx("u", { children: "isolated" }),
          ", meaning that it should't dependend on props, even though it is possible. This is becasue Wompo Components are actually DOM elements, meaning that they can be accessed by other scripts and call methods or access data. This allows to ",
    ...
    },
    {
      ...
      content: /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("p", { children: [
        ...
        `, and set the new state accordingly to the user's interactions. So, when the user clicks a button, if you use the "props approach" you will cause the re-rendering of the modal and of the parent component itself. If you implement the "`,
