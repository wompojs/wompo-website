import{Fragment as n,jsx as e,jsxs as t}from"womp/jsx-runtime";import{defineWomp as l}from"womp";import s from"../../../utils/getPageLayout.js";import o from"../../../components/Code.js";import i from"../../../components/Note.js";import{Link as a}from"womp-router";import d from"../../../examples/Timer.js";import u from"../../../examples/PasswordRevealer.js";const c={title:"useRef hook",description:t(n,{children:["How to use the ",e("code",{children:"useRef"})," hook to keep a value of a variable stable across renders."]}),sections:[{title:"Description",id:"description",content:t(n,{children:[t("p",{children:["The ",e("code",{children:"useRef"})," hook will save the value of a variable across renders. ",e("br",{}),"Consider the following code:"]}),e(o,{code:`
                function Component(){
