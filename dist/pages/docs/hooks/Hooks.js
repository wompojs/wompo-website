import { Fragment as n, jsx as e, jsxs as o } from 'wompo/jsx-runtime';
import { defineWompo as s } from 'wompo';
import i from '../../../utils/getPageLayout.js';
	...
	sections: [
				...
				children: [
					o('p', {
						children: [
							...
							o('ul', {
								children: [
									e('li', { children: 'Make your component dynamic' }),
									e('li', { children: 'Create callbacks that will be executed on specific cases' }),
									e('li', { children: "Keep a variable's value stable across renders" }),
									o('li', { children: ['Get a specific ', e('b', { children: 'Context' })] }),
									e('li', { children: 'Optimize performances by avoiding useless re-renderings' }),
								],
							}),
							'Hooks work like ',
							e('b', { children: 'import statements' }),
							...
							o('ol', {
								children: [
									...
									e('li', { children: 'They cannot be conditional or executed inside loops.' }),
								],
							}),
					...
					children: [
						...
						o('ul', {
							children: [
								o('li', {
									children: [
										e(t, { to: 'useState', children: 'useState' }),
								...
								o('li', {
									children: [
										e(t, { to: 'useReducer', children: 'useReducer' }),
										' - For ',
										e('b', { children: 'Redux' }),
		...
		},
		{
			...
			content: e(n, {
				children: o('p', {
					children: [
						'Effect hooks are what allows to execute a specific ',
						e('b', { children: 'callback' }),
						' when one of your',
						e('b', { children: 'dependencies' }),
						' changes, or simply on the first (or on every) render. This dependencies are simply an array of values. The effect hooks are:',
						o('ul', {
							children: [
								o('li', {
									children: [
										e(t, { to: 'useEffect', children: 'useEffect' }),
										' - After ',
										e('b', { children: 'useState' }),
										...
										e('b', { children: 'Asynchronously' }),
										'.',
									],
								}),
								o('li', {
									children: [
										e(t, { to: 'useLayoutEffect', children: 'useLayoutEffect' }),
										" - It's the same as the",
										' ',
										e('b', { children: 'useEffect' }),
										' hook. The only difference is that the callback is executed',
										' ',
										e('b', { children: 'Synchronously' }),
										' immediately after a render, before you can see visual changes. The ',
										e('i', { children: 'useEffect' }),
										" hook is preferred, because it'll not saturate the stack.",
									],
								}),
							],
						}),
					...
					children: [
						...
						o('ul', {
							children: [
								...
								o('li', {
									children: [
										e(t, { to: 'useCallback', children: 'useCallback' }),
								...
								o('li', {
									children: [
										e(t, { to: 'useMemo', children: 'useMemo' }),
										' - This hook will let you execute a callback function and return its result only when a dependency changes, instead of on every render.',
									],
								}),
							],
						}),
			...
			content: e(n, {
				children: o('p', {
					children: [
						...
						e('b', { children: 'obtain a value provided by another element' }),
						', more specifically, a',
						e('code', { children: 'Context.Provider' }),
						' element. There is only one context hook:',
						e('ul', {
							children: o('li', {
								children: [
									e(t, { to: 'useContext', children: 'useContext' }),
									' - Will return the value provided by the closest parent context provider of the specified context. If there is not one, the default value of the context will be returned. The component that uses this hook will automatically re-render whenever the value provided by the provider changes.',
								],
							}),
						}),
					],
					...
					children: [
						...
						o('ul', {
							children: [
								o('li', {
									children: [
										e(t, { to: 'useId', children: 'useId' }),
										' - Will return a unique string in the format',
										' ',
										e('code', { children: ':w<number>:' }),
								...
								o('li', {
									children: [
										e(t, { to: 'useExposed', children: 'useExposed' }),
								...
								o('li', {
									children: [
										e(t, { to: 'useAsync', children: 'useAsync' }),
										...
										' ',
										e('b', { children: e('i', { children: 'Suspense' }) }),
										' ',
