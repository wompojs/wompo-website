...
import l from '../../../examples/LoggedInUser.js';
				...
				children: [
					...
					t('p', {
						children: [
							...
							' ',
							e(a, { to: '/docs/apis/createContext', children: 'Context' }),
					...
					t('p', {
						children: [
							...
							t('ul', {
								children: [
									e('li', { children: 'Listen to theme changes' }),
									e('li', { children: 'Listen to the current logged-in user changes' }),
									e('li', { children: 'Listen to changes in the state of the whole application' }),
								],
							}),
						],
					}),
		...
		},
		{
			...
			content: t(o, {
				children: [
					e('p', {
						children:
							"Let's analyze a common case: sharing the data of the logged in user to the whole application.",
					}),
					e(n, {
						code: `
              ...
              defineWompo(UserInfo);
					...
					t('p', { children: ['Result:', e(l, {})] }),
					t('p', {
						children: [
							'First, we created the ',
							e('code', { children: 'UserContext' }),
							' context, and then rendered a',
							' ',
							e('code', { children: 'UserContext.Provider' }),
