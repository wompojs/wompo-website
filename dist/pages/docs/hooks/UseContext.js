import{Fragment as o,jsx as e,jsxs as t}from"wompo/jsx-runtime";import{defineWompo as s}from"wompo";import r from"../../../utils/getPageLayout.js";import n from"../../../components/Code.js";import{Link as a}from"wompo-router";import l from"../../../examples/LoggedInUser.js";import c from"../../../components/Note.js";const h={title:"useContext hook",description:t(o,{children:["How to use the ",e("code",{children:"useContext"})," hook to get a specific value shared across a whole portion of your application."]}),sections:[{title:"Description",id:"description",content:e(o,{children:t("p",{children:["This hook allows to get the value provided by a ",e("code",{children:"Context.Provider"}),". Using this hook will also make the component subscribe to the provider, so that it'll be automatically reloaded whenever the provided value changes."]})})},{title:"Usage",id:"usage",content:t(o,{children:[e(n,{code:`
              ...
              defineWompo(UserInfo);
						`,language:"js"}),t("p",{children:["Result:",e(l,{})]}),t("p",{children:["First, we created the ",e("code",{children:"UserContext"})," context, and then rendered a"," ",e("code",{children:"UserContext.Provider"})," in the App component. The provider will pass it's value to all its children components. In fact, then we used the ",e("code",{children:"useContext"}),"hook in the UserInfo component to obtain the informations about the current loggeed in user. This will make the component subscribe to the provider, so that it can be automatically reloaded if the informations about the logged in user changes. To test it, you can see that you can log the user in and out and the UserInfo component will display a different message evert time, even thoug the component doesn't use a ",e("b",{children:"state hook"}),".",e("br",{}),"Note that we obtained this result without passing any prop to the component.",e("br",{}),"Image having a more deeply nested structure and pass the current logged in user information to all the children components. It'd be hell. Using contexts will drastically improve the state management of the whole application."]}),t(c,{severity:"info",children:[e("b",{children:"Note:"})," The useContext hook will get the value of the ",e("b",{children:"closest"})," matched provider. If multiple providers of the same context are above the component, they will be ignored."]})]})}]};export default function i(){return r(h)}s(i,{name:"usecontext-hook-page"});
