...
const content = {
  ...
  description: /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    " hook to get a specific value shared across a whole portion of your application."
  ] }),
  sections: [
    {
      title: "Description",
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          /* @__PURE__ */ jsxs("ul", { children: [
            /* @__PURE__ */ jsx("li", { children: "Listening to theme changes" }),
            /* @__PURE__ */ jsx("li", { children: "Listening to the current logged-in user changes" }),
            /* @__PURE__ */ jsx("li", { children: "Listening to changes in the state of the whole application" })
          ] })
        ] })
      ] })
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          /* @__PURE__ */ jsx("code", { children: "useContext" }),
          "hook in the UserInfo component to obtain the informations about the current loggeed in user. This will make the component subscribe to the provider, so that it can be automatically reloaded if the informations about the logged in user changes. To test it, you can see that you can log the user in and out and the UserInfo component will display a different message evert time, even thoug the component doesn't use a ",
          /* @__PURE__ */ jsx("b", { children: "state hook" }),
          ".",
          /* @__PURE__ */ jsx("br", {}),
          "Note that we obtained this result without passing any prop to the component.",
          /* @__PURE__ */ jsx("br", {}),
          "Image having a more deeply nested structure and pass the current logged in user information to all the children components. It'd be hell. Using contexts will drastically improve the state management of the whole application."
        ] }),
