...
import { Link as r } from 'wompo-router';
const c = {
	title: 'useAsync hook',
	description: t(n, {
		children: [
			'How to use the ',
			e('code', { children: 'useAsync' }),
	...
	sections: [
		{
			...
			content: t(n, {
				children: [
					e('p', { children: 'This hook allows to execute a function that returns a promise.' }),
					t('p', {
						children: [
				...
				children: [
					t('p', {
						children: [
							...
							' ',
							e(r, { to: '/docs/components/suspense', children: 'Suspense' }),
                  ...
                  \${userData}
					...
					t('p', {
						children: [
							...
							' ',
							e('b', { children: "Suspense's fallback" }),
							' while the data of the ',
							e('code', { children: 'User' }),
							' components are being loaded, and ',
							e('b', { children: 'only when every one of them will have finished loading,' }),
