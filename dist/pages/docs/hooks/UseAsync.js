  ...
  sections: [
    ...
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          "The third parameter of the function tells the hook wheather the hook should trigger the parent ",
          /* @__PURE__ */ jsx("code", { children: "Suspense" }),
          " component or not. By default, it is ",
          /* @__PURE__ */ jsx("code", { children: "true" }),
          "."
        ] }),
        /* @__PURE__ */ jsxs(Note, { severity: "info", children: [
          /* @__PURE__ */ jsx("b", { children: "SSR-ready:" }),
          " on the server,",
          " ",
          /* @__PURE__ */ jsx(Link, { to: "/docs/ssr#render-to-string", children: "renderToString" }),
          " awaits every",
          " ",
          /* @__PURE__ */ jsx("code", { children: "useAsync" }),
          " in the tree before resolving. In streaming mode (",
          /* @__PURE__ */ jsx(Link, { to: "/docs/ssr#render-to-stream", children: "renderToStream" }),
          "), an async call inside a",
          " ",
          /* @__PURE__ */ jsx(Link, { to: "/docs/components/suspense", children: "Suspense" }),
          " boundary defers that boundary and flushes it out-of-order when the promise resolves."
        ] })
      ] })
    },
    {
