import{Fragment as o,jsx as e,jsxs as t}from"wompo/jsx-runtime";import{defineWompo as a}from"wompo";import r from"../../../utils/getPageLayout.js";import n from"../../../components/Code.js";import{Link as c}from"wompo-router";import i from"../../../components/Note.js";const h={title:"useEffect hook",description:t(o,{children:["How to use the ",e("code",{children:"useEffect"})," hook to make a component execute some operations on specific situations."]}),sections:[{title:"Description",id:"description",content:e(o,{children:t("p",{children:["The ",e("code",{children:"useEffect"})," hook is one of the main hooks you will use in your application. This hook lets you execute a callback (effect) function after the"," ",e("b",{children:"first render"})," and whenever one of the dependecies changes. This can be quite ideal for:",t("ul",{children:[e("li",{children:"Initializing the component"}),t("li",{children:["Subscribing to events (e.g. ",e("code",{children:"window.addEventListener"}),")"]}),e("li",{children:"Using timeouts and intervals"}),e("li",{children:"Performing animations"}),t("li",{children:["Controlling a non-wompo widget or node in conjuctions with the ",e("code",{children:"useRef"})," ","hook"]})]})]})})},{title:"Usage",id:"usage",content:t(o,{children:[e(n,{code:`
							useEffect(effectFn, dependencies);
						`,language:"js"}),t("p",{children:["The hook accepts two parameters: the ",e("b",{children:"effect function"})," and the"," ",e("b",{children:"list of dependencies"}),". The effect function will be executed on first render and any time one of the dependecies changes. This function can be a void function or can return a second function (called cleaning function) that will be executed"," ",e("b",{children:"before the execution of the next same effect"})," or if the component ",e("b",{children:"unmount"})," ","(is removed from the DOM)."]}),t("p",{children:["If an empty array is given as a list of dependecies, the effect will be executed"," ",e("b",{children:"only"})," after the first render."]}),t("p",{children:["If no dependencies are specified, the effect will be executed on ",e("b",{children:"every"})," render."]}),t(i,{severity:"info",children:[e("b",{children:"Note:"})," The effect will be executed ",e("b",{children:"asynchronously"})," after the component has been rendered, not inline."]})]})},{title:"Example: timeout",id:"timeout-example",content:t(o,{children:[t("p",{children:["Using the ",e("code",{children:"window.setTimeout"})," function is a common use case for the"," ",e("code",{children:"useEffect"})," hook. Here's an example:"]}),e(n,{code:`
              ...
              defineWompo(TimeoutComponent);
						`,language:"js"}),t(i,{severity:"warning",children:["When using timeouts and intervals, remember to ",e("b",{children:"always"})," cancel them using the"," ",e("b",{children:"cleaning function"})," (like in the example). Not doing so can lead to unexpected behaviours, like the execution of code even if the element is no longer in the DOM."]}),t("p",{children:[e("i",{children:"Why the useEffect hook is needed for this case?"}),e("br",{}),"Because if you call the ",e("code",{children:"setTimoeut"})," function directly inside the component, it will be executed ",e("b",{children:"every time"})," the component renders. This usually causes unwanted loops when inside the timeout/interval callback a setState is called."]})]})},{title:"Example: fetching data",id:"fetching-data-example",content:t(o,{children:[t("p",{children:["The ",e("code",{children:"useEffect"})," hook can also be used to fetch data when the component renders."]}),t(i,{severity:"info",children:[e("b",{children:"Note:"})," This example is only made to understand better how the hook works and how to do async operations inside of it. If you actually have to perform data fetching, use the ",e(c,{to:"/docs/hooks/useAsync",children:"useAsync"})," hook instead."]}),e(n,{code:`
              ...
              defineWompo(Code);
						`,language:"js"}),t("p",{children:["In the above example the ",e("code",{children:"Code"})," component accepts a ",e("b",{children:"code"})," prop and a"," ",e("b",{children:"lang"})," prop that will be used to create the highligted HTML that will be injected in the <code> HTML element thanks to the ",e("code",{children:"useRef"})," hook."]})]})}]};export default function s(){return r(h)}a(s,{name:"useeffect-hook-page"});
