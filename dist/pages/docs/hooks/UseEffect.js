...
import { defineWompo as a } from 'wompo';
import r from '../../../utils/getPageLayout.js';
import n from '../../../components/Code.js';
import { Link as c } from 'wompo-router';
			...
			content: e(o, {
				children: t('p', {
					children: [
						...
						' ',
						e('b', { children: 'first render' }),
						' and whenever one of the dependecies changes. This can be quite ideal for:',
						t('ul', {
							children: [
								e('li', { children: 'Initializing the component' }),
								t('li', {
									children: [
										'Subscribing to events (e.g. ',
										e('code', { children: 'window.addEventListener' }),
										')',
									],
								}),
								e('li', { children: 'Using timeouts and intervals' }),
								e('li', { children: 'Performing animations' }),
								t('li', {
									children: [
				...
				children: [
					...
					t('p', {
						children: [
							...
							e('b', { children: 'effect function' }),
							' and the',
							' ',
							e('b', { children: 'list of dependencies' }),
							...
							' ',
							e('b', { children: 'before the execution of the next same effect' }),
							' or if the component ',
							e('b', { children: 'unmount' }),
							' ',
			...
			content: t(o, {
				children: [
					t('p', {
						children: [
							'Using the ',
							e('code', { children: 'window.setTimeout' }),
              ...
              defineWompo(TimeoutComponent);
					...
					t(i, {
						...
						children: [
							...
							' ',
							e('b', { children: 'cleaning function' }),
							' (like in the example). Not doing so can lead to unexpected behaviours.',
						],
					}),
					t('p', {
						children: [
							e('i', { children: 'Why the useEffect hook is needed for this case?' }),
							e('br', {}),
							'Because if you call the ',
							e('code', { children: 'setTimoeut' }),
							' function directly inside the component, it will be executed ',
							e('b', { children: 'every time' }),
				...
				children: [
					...
					t(i, {
						...
						children: [
							...
							e(c, { to: '/docs/hooks/useAsync', children: 'useAsync' }),
							' hook instead.',
						],
					}),
					e(n, {
			...
			content: t(o, {
				children: [
					t('p', {
						children: [
							...
							e('code', { children: 'window.localStorage' }),
              ...
              defineWompo(Theme);
					...
					t(i, {
						severity: 'info',
						children: [
							e('b', { children: 'Effects will be executed in the order they are declared' }),
				...
				children: [
					t('p', {
						children: [
							...
							e(c, { to: '/docs/hooks/useRef', children: 'useRef' }),
							' hook with the third party library ',
							e('b', { children: 'highlight.js' }),
							' and the ',
							e('code', { children: 'useEffect' }),
              ...
              defineWompo(Code);
					...
					t('p', {
						children: [
							...
							e('code', { children: 'Code' }),
							' component accepts a ',
							e('b', { children: 'code' }),
							' prop and a',
							' ',
							e('b', { children: 'lang' }),
							' prop that will be used to create the highligted HTML that will be injected in the ',
							e('b', { children: 'code' }),
							' HTML element thanks to the ',
							e('code', { children: 'useRef' }),
							' hook.',
						],
					}),
