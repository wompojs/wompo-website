import { Fragment as a, jsx as e, jsxs as o } from 'wompo/jsx-runtime';
import { defineWompo as i } from 'wompo';
import h from '../../../utils/getPageLayout.js';
import s from '../../../components/Code.js';
import n from '../../../components/Note.js';
import { Link as t } from 'wompo-router';
const c = {
	title: 'useHook hook',
	description: o(a, {
		children: [
			'How to use the ',
			e('code', { children: 'useHook' }),
				...
				children: [
					...
					o(n, {
						...
						children: [
							...
							e(t, { to: '/docs/custom-hooks', children: 'Custom hooks' }),
							' section for more.',
						],
					}),
				],
				...
				children: [
					o('p', {
						children: [
							...
							e('code', { children: 'currentRenderingComponent' }),
							...
							' ',
							e('code', { children: 'currentHookIndex' }),
            ...
            `,
					...
					o('p', {
						children: [
							...
							e('b', { children: 'not' }),
							' automatically do is ',
							e('b', { children: 'set the hook value' }),
					...
					o('p', {
						children: [
							...
							' ',
							e(t, { to: '/docs/apis/element', children: 'Wompo Element API' }),
							'.',
						],
					}),
					e('p', {
					...
					e('p', {
						children: o(n, {
							...
							children: [
								...
								' ',
								e(t, { to: '/docs/hooks/useState', children: 'useState' }),
								',',
								' ',
								e(t, { to: '/docs/hooks/useEffect', children: 'useEffect' }),
								', or',
								' ',
								e(t, { to: '/docs/hooks/useRef', children: 'useRef' }),
					...
					e('p', {
						children: o(n, {
							...
							children: [
								...
								' ',
								e('code', { children: 'component.hooks[hookIndex]' }),
				...
				children: [
					o('p', {
						children: [
							...
							e('b', { children: 'global stateful storage' }),
							'. This kind of approach is currently used in the ',
							e(t, { to: '/docs/hooks/useContext', children: 'useContext' }),
							...
							e('code', { children: 'onDisconnected' }),
							' callback, like this:',
						],
					}),
					e(s, {
