...
const content = {
  ...
  description: /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    " hook to create your custom advanced hook."
  ] }),
  sections: [
    {
      title: "Description",
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("p", { children: [
          "At some point you may want to further customize how wompo works, and maybe add a specific functionality to your components that Wompo doesn't actually support natively. The ",
          /* @__PURE__ */ jsx("code", { children: "useHook" }),
        ...
        /* @__PURE__ */ jsxs(Note, { severity: "warning", children: [
          ...
          " be used to create ",
          /* @__PURE__ */ jsx("b", { children: "advanced" }),
          " custom hooks. The already present Wompo's hooks cover 90% of the average cases, and you can create a custom hook by simply combining them. See the",
          " ",
          /* @__PURE__ */ jsx(Link, { to: "/docs/guides/custom-hooks", children: "Custom hooks" }),
          " section for more."
        ] })
      ] })
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          "The ",
          /* @__PURE__ */ jsx("code", { children: "useHook" }),
          " hook accepts no parameters and will return always an array with two values: the instance of the currently rendering component, and the current hook index of the component."
        ] }),
        /* @__PURE__ */ jsx("p", { children: "But what is the hook index? Let's analyze how Wompo hooks work in the next section." })
      ] })
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("p", { children: [
          "Maybe you already wondered how can Wompo return always the same values when you use hooks if they have no reference about the current component. The answer is that hooks are ",
          /* @__PURE__ */ jsx("b", { children: "not" }),
          " pure functions. Every time a component renders, the value of an external variable called ",
          /* @__PURE__ */ jsx("code", { children: "currentRenderingComponent" }),
          " is set to the instance of the current rendering component (big surprise huh?). This instance is the same returned by the ",
          /* @__PURE__ */ jsx("code", { children: "useHook" }),
          " hook. Then, another external variable called",
          " ",
          /* @__PURE__ */ jsx("code", { children: "currentHookIndex" }),
          " is set to 0, and incremented every time a hook is called inside of the component. The hook value is internally determined by the hook itself, and also what to return. The hook will be saved into the",
          " ",
          /* @__PURE__ */ jsxs("b", { children: [
            /* @__PURE__ */ jsx("code", { children: "hooks" }),
            " array"
          ] }),
          " ",
          "that every component has (you can actually select a wompo element in the console and write ",
          /* @__PURE__ */ jsx("code", { children: "$0.hooks" }),
          " to see it).",
          /* @__PURE__ */ jsx("br", {}),
        ...
        /* @__PURE__ */ jsx("p", { children: "The code above will not work, but can make you easily get how Wompo works under the hood." }),
        /* @__PURE__ */ jsx(Note, { severity: "info", children: "If you understand this, you also understand why it is so important for your component's hooks to be called in the first lines of the component and why they should NOT be inside conditional statements or loops." }),
        /* @__PURE__ */ jsxs("p", { children: [
          "Going back to the ",
          /* @__PURE__ */ jsx("code", { children: "useHook" }),
          " explanation, the hook will simply return the current rendering component instance and the current hook index. It will also take care of automatically incrementing the hook index, so that you won't have to do it.",
          /* @__PURE__ */ jsx("br", {}),
          "What it will ",
          /* @__PURE__ */ jsx("b", { children: "not" }),
          " automatically do is ",
          /* @__PURE__ */ jsx("b", { children: "set the hook value" }),
          " in the component's hooks array, but we will see how to do it in a moment with an example."
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          " ",
          /* @__PURE__ */ jsx(Link, { to: "/docs/apis/element", children: "Wompo Element API" }),
          "."
        ] }),
    ...
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          "Did it! Now you can simply call the ",
          /* @__PURE__ */ jsx("code", { children: "useBattery()" }),
          " hook inside of your components!"
        ] }),
        /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsxs(Note, { severity: "info", children: [
          /* @__PURE__ */ jsx("b", { children: "Info:" }),
          " you could have actually get the same result using native Wompo hooks like",
          " ",
          ...
          " hook and use instead other native Wompo hooks to achieve the same result.",
          /* @__PURE__ */ jsx("br", {}),
        ...
        /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsxs(Note, { severity: "warning", children: [
          ...
          " modify the value of another hook. Always modify the",
          " ",
    ...
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          /* @__PURE__ */ jsx(Link, { to: "/docs/hooks/useEffect", children: "useEffect" }),
          " hook does) to execute before the effect is applied or ",
          /* @__PURE__ */ jsx("b", { children: "when the component unmounts" }),
          ". Implementing this is very easy: all you have to do is save the hooks as an object, and set a ",
          /* @__PURE__ */ jsx("b", { children: "cleanupFunction" }),
          " property to it. This function must accept no parameters, and will be automatically executed when the component unmounts.",
          /* @__PURE__ */ jsx("br", {}),
          "Example:"
        ] }),
        /* @__PURE__ */ jsx(
