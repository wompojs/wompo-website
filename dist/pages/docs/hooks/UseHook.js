import{Fragment as a,jsx as e,jsxs as o}from"womp/jsx-runtime";import{defineWomp as i}from"womp";import h from"../../../utils/getPageLayout.js";import s from"../../../components/Code.js";import n from"../../../components/Note.js";import{Link as t}from"womp-router";const c={title:"useHook hook",description:o(a,{children:["How to use the ",e("code",{children:"useHook"})," hook to create your custom advanced hook."]}),sections:[{title:"Description",id:"description",content:o(a,{children:[o("p",{children:["At some point you may want to further customize how womp works, and maybe add a specific functionality to your components that Womp doesn't actually support. The"," ",e("code",{children:"useHook"}),"hook will let you have access to the component's instance and the hook index."]}),o(n,{severity:"warning",children:["This hook should ",e("b",{children:"only"})," be used to create ",e("b",{children:"advanced"})," custom hooks. The already present Womp's hooks cover 90% of the average cases, and you can create a custom hook by simply combining them. See the ",e(t,{to:"/docs/custom-hooks",children:"Custom hooks"})," section for more."]})]})},{title:"Usage",id:"usage",content:o(a,{children:[e(s,{code:`
							const [component, hookIndex] = useHook();
						`,language:"js"}),o("p",{children:["The ",e("code",{children:"useHook"})," hook accepts no parameters and will return always an array with two values: the instance of the currently rendering component, and the current hook index of the component."]}),e("p",{children:"But what is the hook index? Let's analyze how Womp hooks work in the next section."})]})},{title:"Deep dive into Womp hooks",id:"deep-dive",content:o(a,{children:[o("p",{children:["Maybe you already wondered how can Womp return always the same values when you use hooks if they have no reference about the current component. The answer is that hooks are"," ",e("b",{children:"not"})," pure functions. Every time a component renders, the value of an external variable called ",e("code",{children:"currentRenderingComponent"})," is set to the instance of the current rendering component (big surprise huh?). This instance is the same returned by the ",e("code",{children:"useHook"})," hook. Then, another external variable called"," ",e("code",{children:"currentHookIndex"})," is set to 0, and incremented every time a hook is called inside of the component. The hook value is internally determined by the hook itself, and also what to return. The hook will be saved into the"," ",o("b",{children:[e("code",{children:"hooks"})," array"]})," ","that every component has (you can actually select a womp element in the console and write ",e("code",{children:"$0.hooks"})," to see it).",e("br",{}),"It's something like this (very approximatively):"]}),e(s,{code:`
