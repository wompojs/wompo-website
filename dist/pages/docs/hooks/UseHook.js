  ...
  sections: [
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("p", { children: [
          "At some point you may want to further customize how womp works, and maybe add a specific functionality to your components that Womp doesn't actually support. The",
          " ",
          /* @__PURE__ */ jsx("code", { children: "useHook" }),
        ...
        /* @__PURE__ */ jsxs(Note, { severity: "warning", children: [
          ...
          " custom hooks. The already present Womp's hooks cover 90% of the average cases, and you can create a custom hook by simply combining them. See the ",
    ...
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx("p", { children: "But what is the hook index? Let's analyze how Womp hooks work in the next section." })
      ] })
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("p", { children: [
          "Maybe you already wondered how can Womp return always the same values when you use hooks if they have no reference about the current component. The answer is that hooks are",
          " ",
          ...
          " ",
          "that every component has (you can actually select a womp element in the console and write ",
        ...
        /* @__PURE__ */ jsx("p", { children: "The code above will not work, but can make you easily get how Womp works under the hood." }),
    ...
    },
    {
      ...
      content: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsxs(Note, { severity: "info", children: [
          ...
          " you could have actually get the same result using native Womp hooks like",
          " ",
