import{Fragment as t,jsx as e,jsxs as o}from"wompo/jsx-runtime";import{defineWompo as n}from"wompo";import a from"../../../utils/getPageLayout.js";import s from"../../../components/Code.js";const i={title:"useMemo hook",description:o(t,{children:["How to use the ",e("code",{children:"useMemo"})," hook to save the result of a function without re-calculating it on every render."]}),sections:[{title:"Description",id:"description",content:o(t,{children:[o("p",{children:["The ",e("code",{children:"useMemo"})," hook will let you save the result of a function so that it will not be re-calculated on every render. Using it can considerably improve performances, especially if the function performs heavy operations."]}),o("p",{children:["Common use cases for this hook are:",o("ul",{children:[e("li",{children:"Sorting arrays"}),e("li",{children:"Filtering arrays"}),e("li",{children:"Building objects"})]})]})]})},{title:"Usage",id:"usage",content:o(t,{children:[e(s,{code:`
							const result = useMemo(calculatorFn, dependencies);
						`,language:"js"}),o("p",{children:["The ",e("code",{children:"useMemo"})," hook accepts two parameters: the ",e("b",{children:"calculator"})," function and a list of dependencies. The calculator function accepts no parameters and should be pure and not be asynchronous. The new result of this function will be returned by the hook on the first render or whenever one of the listed ",e("b",{children:"dependencies"})," changes."]}),e("p",{children:"You should use this hook whenever possible if you have to calculate the value of something through a function. Example:"}),e(s,{code:`
