...
import { defineWompo as n } from 'wompo';
import a from '../../../utils/getPageLayout.js';
				...
				children: [
					o('p', {
						children: [
							'The ',
							e('code', { children: 'useMemo' }),
							' hook will let you save the result of a function so that it will not be re-calculated on every render. Using it can considerably improve performance, especially if the function performs heavy operations.',
						],
					}),
					o('p', {
						children: [
							...
							o('ul', {
								children: [
									e('li', { children: 'Sorting arrays' }),
									e('li', { children: 'Filtering arrays' }),
									e('li', { children: 'Building objects' }),
								],
							}),
						],
					}),
				...
				children: [
					...
					o('p', {
						children: [
							...
							e('b', { children: 'calculator' }),
							' function and a list of dependencies. The calculator function accepts no parameters and should be pure and not be asynchronous. The new result of this function will be returned by the hook on the first render or whenever one of the listed dependencies changes.',
						],
					}),
					e('p', {
						children:
                ...
                \`;
					...
					o('p', {
						children: [
							...
							' ',
							e('code', { children: 'OrderedUsersList' }),
							' component we sorted them inside the useMemo hook to save the sorted users list.',
							e('br', {}),
							'This is a simple example, but if you increase the number of generated users so that the sorting will be more computationally expensive, you can really see how the',
							' ',
							e('b', { children: 'useMemo hook can save your life' }),
