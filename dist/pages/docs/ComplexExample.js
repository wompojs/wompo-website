import{Fragment as h,jsx as e,jsxs as t}from"womp/jsx-runtime";import{defineWomp as i}from"womp";import s from"../../utils/getPageLayout.js";import o from"../../components/Code.js";import{Link as n}from"womp-router";import d from"../../components/Note.js";import r from"../../tutorials/TodoList.js";const l={title:"Complex Example",description:"Let's create a TODO list app and explore more concepts of the Womp library.",sections:[{title:"Todo List app",id:"todo-list-app",content:t(h,{children:[t("p",{children:["In this project we will build a simple Todo List app. By doing that you'll get more comfortable using Womp.",e("br",{}),"What we want is a component component that will render an input and a button to add a todo item, with a list of already added todos below. We then also want that the Todos that we added are saved in the local storage of the browser, so that they are not lost once we reload the page.",e("br",{}),"Let's start by creating the ",e("code",{children:"TodoList"})," component."]}),e(o,{code:`
