...
import r from '../../components/Note.js';
import c from '../../examples/UseTime.js';
const u = {
	...
	sections: [
			...
			content: e(o, {
				children: t('p', {
					children: [
						...
						e('b', { children: 'every' }),
						' single exigency that a developer can have while developing Wompo Components, but they are the ',
						e('b', { children: 'base' }),
		...
		},
		{
			...
			content: t(o, {
				children: [
					...
					e('p', { children: '...or...' }),
					e('p', { children: e('i', { children: 'inside other hooks!' }) }),
					t('p', {
						children: [
            ...
            `,
					...
					t('p', {
						children: [
							...
							' hook and the ',
							e(a, { to: '/docs/hooks/useCallback', children: 'useCallback' }),
							' hook to create the custom',
							' ',
							e('code', { children: 'useLocalStorage' }),
		...
		},
		{
            ...
            `,
					...
					e('p', { children: 'And then, in a component:' }),
					e(n, {
						code: `
		...
		},
		{
			...
			content: t(o, {
				children: [
					...
					' ',
					e(a, { to: '/docs/hooks/useHook', children: 'useHook' }),
					' hook reference.',
				],
			}),
		},
