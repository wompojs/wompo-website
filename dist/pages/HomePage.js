import{defineWompo as r,html as o}from"wompo";import{Link as a}from"wompo-router";import n from"../components/Code.js";import s from"../components/Home/BuiltInCssModules.js";import t from"../components/Home/MoreWidget.js";const c=o`
	<svg
...
`;export default function i({styles:e}){return o`
		<main class=${e.main}>
			<section class=${e.hero}>
				...
				<div class=${e.buttons}>
					<a
						...
						class="${e.btn} ${e.btnPrimary}"
					>
						&gt; npm i wompo
					</a>
					<${a} to="/docs/overview" class="${e.btn} ${e.btnSecondary}">Documentation</${a}>
				</div>
			</section>
      
      <section class=${e.section}>
        <div class=${e.whySection}>
          <h2 class=${e.sticky}>Why wompo?</h2>
          <div>
            <p class=${e.whyParagraph}>
      ...
      <section class="${e.section} ${e.shadowSection}">
        <h2>Shadow DOM?</h2>
        <h3>Yes, but <span class=${e.coloredSpan}>NO</span></h3>
        <p style="max-width: 60rem;">
          ...
          select elements through <code class=${e.code}>document.querySelector</code> (which a lot
          of third party libraries rely on), and, first of all, the need to learn what
          <b>Shadow DOM</b> is and what it does.<br/>
      ...
      <section class="${e.section} ${e.cssModule}">
      ...
      <section class="${e.section} ${e.helpSection}">
        <h2>Help Wompo to grow</h2>
        <p>
          Every kind of support on this project, even just a feedback on it, is highly appreciated!
          <br/>
          You can further support the Wompo project by becoming a <b>contributor</b> or a
          <b>sponsor</b>, and <u>be featured on this Website</u>.
          <br/>
          The purpose of Wompo is to create <b>easy-shareable</b> components that can be used on
          every Web Environment, in cooperation with any library or framework, without needing to
          worry about compatibility issues.
        </p>
        <h3>
          <a href="https://github.com/Saderyal/wompo/graphs/contributors" target="_blank">
