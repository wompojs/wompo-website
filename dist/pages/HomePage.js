import{defineWompo as a,html as i}from"wompo";import{Link as t}from"wompo-router";export default function o({styles:e}){return i`
		<main class=${e.main}>
			<section class=${e.hero}>
				...
				<div class=${e.buttons}>
					...
					<${t} to="/docs/overview" class="${e.btn} ${e.btnSecondary}">Documentation</${t}>
				</div>
			</section>
      ...
      <section class="${e.section} ${e.shadowSection}">
        ...
        <p style="max-width: 60rem;">
          ...
          select elements through <code class=${e.code}>document.querySelector</code>, and, first
