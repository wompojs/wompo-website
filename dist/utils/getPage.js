...
export default function getPageLayout(contents) {
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex" }, children: [
    /* @__PURE__ */ jsx(MainContent, { title: contents.title, description: contents.description, children: contents.sections.map((section) => /* @__PURE__ */ jsx(ContentSection, { title: section.title, id: section.id, children: section.content })) }),
    /* @__PURE__ */ jsx(
      SideMenu,
      {
