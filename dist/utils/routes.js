export const docsRoutes = [
  {
    ...
    meta: {
      ...
      description: "Wompo has the following features: react-like API, performant, built-in CSS modules, automatic component naming, re-usable, has JSX Support, is bundle free."
    }
  },
  {
    title: "Installation",
    ...
    subRoutes: [
      {
        ...
        meta: {
          ...
          description: "The attrs function spreads a bag of attributes, events, and properties onto a single element inside an html template."
        }
      },
      {
        title: "createContext",
        ...
        meta: {
          ...
          description: "The createContext function allows to create a Context to share between a portion of your application."
        }
      },
      {
        title: "createPortal",
        ...
        meta: {
          ...
          description: "The createPortal function allows to render custom HTML in another area of the DOM."
        }
      },
      {
        title: "defineWompo",
        ...
        meta: {
          ...
          description: "The defineWompo function will transform your functional Component into a Web Component, so that it can be used in your HTML."
        }
      },
      {
        title: "Dynamic Tags",
        ...
        meta: {
          ...
          description: "Use a runtime value as the tag name of an element inside an html template, including components, built-in tags, and conditional expressions."
        }
      },
      {
        title: "Element API",
        ...
        meta: {
          ...
          description: "Check which functions and data you can access in your custom component DOM element."
        }
      },
      {
        title: "html",
        ...
        meta: {
          ...
          description: "The html function lets you build your component's HTML as a string, and get the dynamic parts of it."
        }
      },
      {
        title: "lazy",
        ...
        meta: {
          ...
          description: "Learn how to use the lazy function to load a component only when it's used and improve performances."
        }
      },
      {
      ...
      },
      {
        ...
        meta: {
          ...
          description: "Learn how you can modify Wompo's default options for your custom components."
        }
      }
    ]
  },
  {
    ...
    meta: {
      title: "Typescript",
      description: "Learn how to use Typescript and improve your development experience with Wompo."
    }
  },
  {
    title: "SSR",
