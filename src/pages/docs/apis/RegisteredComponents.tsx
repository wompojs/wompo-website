...
const content: Contents = {
	...
	description: <>How to get the collection of the components registered in the browser.</>,
	sections: [
		{
			title: 'Description',
			id: 'description',
			content: (
				<>
					<p>
						The <code>registeredComponent</code> constant is an object exported by the Wompo library
						that contains the names of the registered Web Components as keys, and their
