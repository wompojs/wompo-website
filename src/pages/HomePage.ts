...
import BuiltInCssModules from '../components/Home/BuiltInCssModules.js';
import MoreWidget from '../components/Home/MoreWidget.js';
	...
	return html`
      ...
      <section class="${s.section} ${s.shadowSection}">
        ...
        <p style="max-width: 60rem;">
          ...
          select elements through <code class=${s.code}>document.querySelector</code> (which a lot
      ...
      <section class="${s.section} ${s.cssModule}">
      ...
      <section class="${s.section} ${s.helpSection}">
